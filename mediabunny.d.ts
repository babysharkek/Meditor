 ...
 * @public
 */
export declare const AUDIO_CODECS: readonly [
	"aac",
	"opus",
	"mp3",
	"vorbis",
 ...
 * @public
 */
export declare const canEncodeAudio: (
	codec: AudioCodec,
	options?: {
		numberOfChannels?: number;
		sampleRate?: number;
 ...
 * @public
 */
export declare const canEncodeSubtitles: (
	codec: SubtitleCodec,
) => Promise<boolean>;
 ...
 * @public
 */
export declare const canEncodeVideo: (
	codec: VideoCodec,
	options?: {
		width?: number;
		height?: number;
 ...
 * @public
 */
export declare const getEncodableAudioCodecs: (
 ...
 * @public
 */
export declare const getEncodableSubtitleCodecs: (
 ...
 * @public
 */
export declare const getEncodableVideoCodecs: (
 ...
 * @public
 */
export declare const getFirstEncodableAudioCodec: (
	checkedCodecs: AudioCodec[],
	options?: {
		numberOfChannels?: number;
		sampleRate?: number;
 ...
 * @public
 */
export declare const getFirstEncodableSubtitleCodec: (
	checkedCodecs: SubtitleCodec[],
 ...
 * @public
 */
export declare const getFirstEncodableVideoCodec: (
	checkedCodecs: VideoCodec[],
	options?: {
		width?: number;
		height?: number;
 ...
 * @public
 */
export declare const NON_PCM_AUDIO_CODECS: readonly [
	"aac",
	"opus",
	"mp3",
	"vorbis",
 ...
 * @public
 */
export declare const PCM_AUDIO_CODECS: readonly [
	"pcm-s16",
	"pcm-s16be",
	"pcm-s24",
	"pcm-s24be",
 ...
 * @public
 */
export declare const registerDecoder: (
 ...
 * @public
 */
export declare const registerEncoder: (
 ...
 * @public
 */
export declare const VIDEO_CODECS: readonly [
	"avc",
	"hevc",
	"vp9",
	"av1",
 ...
 * @public
 */
export declare const VIDEO_SAMPLE_PIXEL_FORMATS: readonly [
	"I420",
	"I420P10",
	"I420P12",
	"I420A",
 ...
 * @public
 */
export declare type VideoSamplePixelFormat =
	(typeof VIDEO_SAMPLE_PIXEL_FORMATS)[number];
